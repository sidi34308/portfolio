...
export default function Home() {
  return (
    <main className="text-black font-['Inter']">
      ...
      <section id="work" className="min-h-screen p-8 xl:pl-[20rem] xl:pr-[20rem] bg-[#fff]">
        <h2 className="text-center p-12">
          <span className="text-black text-5xl font-bold font-['Inter'] leading-[48px]">A small selection of </span>
          <span className="text-teal-400 text-5xl font-bold font-['Inter'] leading-[48px]">recent projects</span>
        </h2>
      ...
      <section id="about" className="background flex flex-col justify-center min-h-screen p-8 xl:pl-[20rem] xl:pr-[20rem]  bg-[#F7F7F7] ">
        <h2 className="text-3xl font-bold">About Me</h2>
        <p className="paragraph"> Hello! I'm Sidi Chaikh, a front-end developer based in Doha, Qatar. Currently pursuing a Bachelor of Science in Computer Science at Qatar University, I have a keen interest in building responsive and visually appealing websites. With experience in both front-end and back-end development, I bring a comprehensive skill set to every project I undertake.My technical expertise includes HTML, CSS, JavaScript, React, Next.js, Node.js, Express.js, SQL, and more. I am also proficient in design tools such as Adobe Creative Suite, Figma, and Blender.</p>
        <Skills />
      </section>
      {/* 
